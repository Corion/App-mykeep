...
try {
  self.workbox.v['workbox:precaching:3.0.0-alpha.1'] = 1;
...
var showWarningsIfNeeded = (entriesMap => {
  ...
  logger_mjs.logger.unprefixed.warn(`You can learn more about why this might be a ` + `problem here: https://docs.google.com/document/d/1i83D4x_1Jz2JT3BCRjO` + `18m-vdL9uG7ksscqZ_E0XjO0/edit?usp=sharing`);
